...
<html>
    ...
    <div class="container">
        ...
        <div class="user"><h3>Reset Staff Balance</h3></div> 
        
        <div class="card" >
				<img class="card-img-top" src="images/top_card.jpg" alt="Card image cap">
				<div class="card-body">
                    <form action="" method="post" class="form-horizontal"  role="form">
                        <h2>Staff Balances Reset Failed</h2>
                        <p>Balances were Reset by <?php echo $_SESSION["user_reset"]; ?> on <?php echo $_SESSION["user_reset_date"]; ?></p>
                    </form>
                </div>
                </div>
