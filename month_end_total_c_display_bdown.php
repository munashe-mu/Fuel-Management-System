				...
				<div class="card-body">
                    ...
                    <tr>
                      <th>Date</th>
                        ...
                        $resultset = $mysqli->query("SELECT t.fuel_type,sum(t.litres_drawn) as Litres,t.date
                        ...
                        GROUP BY t.fuel_type,date ORDER BY t.date");
                        ...
                        while($rows=$resultset->fetch_assoc())
                        {
                            ...
                            echo "<tr><td>$dt</td><td>$ftype</td><td>$lit</td></tr>";
