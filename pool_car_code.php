...
$_SESSION["pool_car_balance"] = $row['balance'];
$_SESSION["pool_car_owner"] = $row['employee'];
    $_SESSION["pool_car_div"] = $row['division'];
     $_SESSION["pool_car_dept"] = $row['dept'];
$_SESSION["pool_car_reg_num"] = $row['reg_number'];
 $_SESSION["pool_car_vehicle"] = $row['vehicle_make'];
if(strlen($_SESSION["pool_car_owner"])> 0){
    
    $_SESSION["pool_car_emp_code"] = $row['emp_code'];
    ...
    $user_reset = $row1['user'];
        ...
        if(empty($user_reset)){
             ...
             header("location:pool_car_capture"); 
        }
    ...
    header("location:pool_car_code?val=invalid");
}
}   
}
    ...
    <div class="container">
        ...
        <div class="card" >
                ...
                <tr><td><?php if(!isset($_GET['val'])){
                        ...
                        ?></td><td></td></tr>
                    <tr><td>Enter Employee Code / Vehicle Reg Number</td>
