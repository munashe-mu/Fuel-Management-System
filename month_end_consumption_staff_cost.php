...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("location:month_end_staff_c_display_cost");
...
<html>
    ...
    <div class="container">
        ...
        <div class="user"><h3>Staff Month End Consumption Cost</h3></div>
                       ...
                       <select class="form-control" id="dated" name="dated" required>
                        ...
                        <td>
                            ...
                            <option value="1">MEDICAL AID</option>
                             ...
                             <option value="4">BOARD MEMBER</option>
                             <option value="5">DATA AFRICA</option>
                            </select>
                            </td><td><button class="btn-success">Open Report</button></td>
                        </tr>
                    </table>
                    </form>
                </div>
