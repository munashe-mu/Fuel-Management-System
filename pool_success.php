        ...
        <div class="card" >
				...
				<div class="card-body">
                  ...
                  <p>Transaction Saved Succesfully</p>
                    ...
                    <tr>
                        <td>Item Name:</td><td><?php echo $_SESSION["item_name"] ;?></td></tr>
                        <tr><td>Division:</td><td><?php echo  $_SESSION["division"] ;?></td></tr>
                       
                        <tr><td>Litres Drawn:</td> <td><?php echo $_SESSION["litre"];?></td></tr>
                        <tr><td>Fuel Type:</td><td><?php echo  $_SESSION["ftype"] ;?></td></tr>
                        <tr><td>Balance:</td><td><?php echo $_SESSION["balance_pool"] ?></td>
                        </tr>
                        <tr>
                        <td><button class="btn-success">New Transaction</button></td>
                        <td></td>    
                        </tr>
                    </table>
                    </form>
