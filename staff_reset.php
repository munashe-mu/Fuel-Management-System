    ...
    <div class="container">
        ...
        <div class="card" >
				...
				<div class="card-body">
                    ...
                    <table class="table">
                        <small>NB: This task should only be done on the first day of the month. Your name and the time will be logged for audit purposes</small>
                <tr><td><a href="staff_reset_process">Click Here To Reset Balances</a></td><td><a href=""></a></td><td><a href=""></a></td></tr>
