...
if($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if($litre > $bal){
     header("location:transactions_capture?val=err");   
   }elseif ($date==""){
       header("location:transactions_capture?val=errdate"); 
   }else{
         header("location:cap_approve");
   }
				...
				<div class="card-body">
                  ...
                  <tr><td>Employee Name</td><td><?php echo $_SESSION["fn_cap"]." ". $_SESSION["sn_cap"];?></td></tr>
                    ...
                    <tr><td>Fuel Type</td>
                        ...
                        <td>
                        <div class="input-group date form_datetime col-md-5" data-date="2019-10-01T05:25:07Z" data-date-format="yyyy-mm-dd" data-link-field="dtp_input1">
